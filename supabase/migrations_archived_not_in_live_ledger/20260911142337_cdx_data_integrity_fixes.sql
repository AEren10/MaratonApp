-- =====================================================================
-- 2026-09-23 · BU DOSYA CANLIYA HIC UYGULANMADI VE UYGULANMAMALI.
--
-- Icerigi bugun parca parca dogrulandi:
--   · plan_tasks bolumu ZATEN canlida (kolon var, NOT NULL, indeksli)
--   · profiles net kolon izni 20260921161331 ile verildi
--   · FK indeksleri + get_private_export_data bugun
--     20260923_clde_private_export_and_fk_indexes ile uygulandi
--   · persist_route_revision surumu ESKIDIR
--
-- persist_route_revision blogu YORUM SATIRINA ALINDI. Canlidaki surum daha
-- yeni: icinde has_feature_access kapisi ve 22 Eylul'de eklenen "aktif slot
-- doluysa terfi etme" mantigi var. Bu dosya oldugu gibi `supabase db push`
-- ile gonderilseydi ikisini de sessizce geri alirdi -- ledger'da olmadigi
-- icin bir sonraki push onu uygulamaya calisirdi. Mayin temizlendi.
-- =====================================================================
...
-- [2026-09-23'te devre disi birakildi -- yukaridaki nota bak]
