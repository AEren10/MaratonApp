...
const s = StyleSheet.create({
  ...
  title: { fontFamily: "Bricolage_400", fontSize: 17 },
  subtitle: { ...TYPOGRAPHY.caption, marginTop: 2 },
  viewAll: { fontFamily: "Archivo_600", fontSize: 13 },
  progressWrap: {
    flexDirection: "row",
    alignItems: "center",
    gap: SPACING.sm,
  ...
  startBtnText: { fontFamily: "Archivo_600", fontSize: 12 },
  badgeText: { fontFamily: "Archivo_600", fontSize: 11, letterSpacing: 0.3 },
  countText: { fontFamily: "Archivo_500", fontSize: 13 },
  aiTag: { paddingHorizontal: SPACING.sm, paddingVertical: SPACING.xs, borderRadius: SPACING.sm },
  aiTagText: { fontFamily: "Archivo_600", fontSize: 11 },
  moreRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
  ...
  moreText: { fontFamily: "Archivo_500", fontSize: 13 },
  emptyTitle: { fontFamily: "Bricolage_400", fontSize: 16 },
  ...
  emptyBtnText: { fontFamily: "Archivo_600", fontSize: 14 },
});
