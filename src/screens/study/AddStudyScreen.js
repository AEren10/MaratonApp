...
const st = StyleSheet.create({
  ...
  segText: { fontFamily: "Archivo_600", fontSize: 13 },
  ...
  inlineLabel: { fontFamily: "Archivo_400", fontSize: 11 },
  inlineInput: { fontFamily: "Bricolage_400", fontSize: 22, textAlign: "center", padding: 0, minWidth: 60 },
