...
const styles = StyleSheet.create({
  ...
  stepLabel:  { fontFamily: "Archivo_600", fontSize: 11, letterSpacing: 1.4, textTransform: "uppercase" },
  title:      { fontFamily: "Bricolage_400", fontSize: 26, letterSpacing: -0.6, marginTop: 10 },
  subtitle:   { fontFamily: "Archivo_400", fontSize: 14, lineHeight: 20, marginTop: 6 },
  center:     { flex: 1, alignItems: "center", justifyContent: "center" },
  bigNumber:  { fontFamily: "Bricolage_400", fontSize: 88, letterSpacing: -4, lineHeight: 88 },
  unit:       { fontFamily: "Bricolage_400", fontSize: 20, lineHeight: 26 },
  estimate:   { fontFamily: "Archivo_500", fontSize: 13, lineHeight: 18, marginTop: 10 },
  ...
  rangeLabel: { fontFamily: "Archivo_400", fontSize: 11, lineHeight: 14 },
  ...
  ctaText:    { fontFamily: "Archivo_600", fontSize: 16, lineHeight: 20 },
});
