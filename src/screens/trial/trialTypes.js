...
// All subjects flattened (used by branch trial picker)
export const ALL_SUBJECTS = [
  ...TYT_SUBJECTS,
  ...AYT_SAY_SUBJECTS,
  // dedupe ayt_matematik
  ...AYT_EA_SUBJECTS.filter((s) => s.key !== "ayt_matematik"),
  ...AYT_SOZ_SUBJECTS.filter(
...
export const TRIAL_TYPES = {
  ...
  BRANCH: {
    ...
    totalQuestions: null, // dynamic per subject
  },
};
...
export function getSubjectsForType(typeCode, branchSubjectKey = null) {
  ...
  if (typeCode === "BRANCH") {
    ...
    return ALL_SUBJECTS.filter((s) => s.key === branchSubjectKey);
  }
